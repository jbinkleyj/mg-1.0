...
char *SCCS_id_ppm = "@(#)ppm.c	1.4 16 Mar 1994";
...
boolean		excluded[16384]={false};	/* excluded characters */
...
eventptr	s[FIXEDORDER+1]={NULL},		/* current contexts */
		t[FIXEDORDER+1]={NULL};		/* new contexts */
