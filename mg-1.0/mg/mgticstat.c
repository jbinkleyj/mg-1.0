...
void main(int argc, char *args[])
{
	...
	int count;
	int small1,small2,small4,small9,small16,small25,small36,small49,small64,small81,small100;
	marktype d;
	int avx,avy;
	int hhh,www,i;
	...
	if(lib==NULL) error(args[0],"Trouble opening library file","");
	...
	while(!isEOF(lib)){
		  ...
		  error(args[0],"error in library file","");
		...
		count++;
		if(count%5000==0) fprintf(outf,"%dk ",count/1000);
		}
