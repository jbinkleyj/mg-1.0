 ...
 *
 *       @(#)mg_text_estimate.c	1.6 16 Mar 1994
 *
 **************************************************************************/
...
char *SCCS_Id_text_estimate = "16 Mar 1994 @(#)mg_text_estimate.c	1.6";
...
void main(int argc, char **argv)
{
  ...
  while ((ch = getopt (argc, argv, "BMDYHh")) != -1)
	...
	break;
      case 'h' :
      case '?' :
	printf ("usage: %s [-h] [B|M|D|Y|H] stats_dict comp_dict\n",
		argv [0]);
	exit(1);
      }
...
static int stats_comp(const void *a, const void *b)
{
