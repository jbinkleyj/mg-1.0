 ...
 *
 *       @(#)bitio_mems.c	1.3 16 Mar 1994
 *
 **************************************************************************/
 
char *SCCS_Id_bitio_mems = "@(#)bitio_mems.c	1.3 16 Mar 1994";
...
void BIO_Mems_Encode_Start(unsigned char *buf, unsigned long pos, 
			   mems_bitio_state *bs)
{
...
void BIO_Mems_Decode_Start(unsigned char *buf, unsigned long pos, 
			   mems_bitio_state *bs)
{
...
void BIO_Mems_Encode_Seek(unsigned long pos, mems_bitio_state *bs)
{
  ENCODE_CONTINUE(*bs)
  ENCODE_SEEK(pos);
  ENCODE_PAUSE(*bs)
