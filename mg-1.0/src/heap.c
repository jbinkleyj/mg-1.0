 ...
 *
 *       @(#)heap.c	1.4 16 Mar 1994
 *
 **************************************************************************/

char *SCCS_Id_heap = "@(#)heap.c	1.4 16 Mar 1994";
...
static void heap_heapify(void *heap, int size, int num, int curr, heap_comp hc)
{
...
static void heap_pullup(void *heap, int size, int num, heap_comp hc)
{
